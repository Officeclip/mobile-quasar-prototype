...
<template>
  ...
  <div>
    <q-list>
      ...
      <q-item class="column">
        <q-input :model-value="startsModelValue" @update:model-value="(newValue) => (startDate = newValue as string)"
        ...
        <q-input :model-value="endsModelValue" @update:model-value="(newValue) => (endDate = newValue as string)"
